...
def test_to_async_postgres_url_neon_uses_asyncpg_ssl_parameter() -> None:
    assert (
        to_async_postgres_url(
            "postgresql://user:secret@ep-cool-darkness-123456-pooler.us-east-2.aws.neon.tech/neondb"
            "?channel_binding=require"
        )
        == "postgresql+asyncpg://user:secret@ep-cool-darkness-123456-pooler.us-east-2.aws.neon.tech/neondb?ssl=require"
    )


def test_to_async_postgres_url_neon_translates_sslmode_for_asyncpg() -> None:
    assert (
        to_async_postgres_url(
            "postgresql://user:secret@ep-cool-darkness-123456-pooler.us-east-2.aws.neon.tech/neondb"
